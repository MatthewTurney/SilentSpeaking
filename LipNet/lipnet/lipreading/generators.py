...
class BasicGenerator(keras.callbacks.Callback):
    ...
    def build(self, **kwargs):
        ...
        self.align_path     = os.path.join(self.dataset_path, 'align_ipa')
        self.build_dataset()
    ...
    def build_dataset(self):
        ...
        print("video path: " + str(self.train_path))
        self.train_list = self.enumerate_videos(os.path.join(self.train_path, "s*/*.mpg"))
        self.val_list   = self.enumerate_videos(os.path.join(self.val_path, "s*/*.mpg"))
